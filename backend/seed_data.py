...
def run():
    ...
    cat_office = Category.objects.create(
        name="Văn phòng phẩm",
    ...
    print("Tạo Suppliers...")
    sup_phongvu = Supplier.objects.create(
        name="Phong Vũ",
        phone="18006868",
        email="contact@phongvu.vn",
    )
    sup_thienlong = Supplier.objects.create(
        name="Thiên Long",
        phone="19008080",
        email="cskh@thienlong.vn",
    )
    sup_hoaphat = Supplier.objects.create(
        name="Hòa Phát",
        phone="18009090",
        email="info@hoaphat.com",
    )
    ...
    products_data = [
        ...
        },
        {
            ...
            "sku": "PEN-TL-027",
            "category": cat_office,
            "supplier": sup_thienlong,
            "unit": "box",
            "price": 60000,
            "quantity": 100,
        },
        {
            "name": "Giấy in Double A A4",
            "sku": "PAP-AA-A4",
            "category": cat_office,
            "supplier": sup_thienlong,
            "unit": "box",
        ...
        {
            "name": "Bàn làm việc Hòa Phát 1m2",
            "sku": "DESK-HP-120",
            "category": cat_furniture,
            "supplier": sup_hoaphat,
            "unit": "piece",
            "price": 1500000,
            "quantity": 15,
        },
